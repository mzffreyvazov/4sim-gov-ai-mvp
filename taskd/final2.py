...
"""
    ...
    # --- Part 2: HTML and PPTX generation ---
    try:
        # Generate HTML slides
        generated_html_files = generate_html_slides(output_json)
        logger.info(f"Successfully generated {len(generated_html_files)} HTML slide files.")
